...
describe('Articles Endpoints', function() {
  ...
  describe(`GET /api/articles`, () => {
    ...
    context('Given there are articles in the database', () => {
      const testUsers = makeUsersArray(); // load users
      const testArticles = makeArticlesArray(); // load articles

      // In each test where the beforeEach hook is used to load data, 
      // ensure that the users are loaded first.
